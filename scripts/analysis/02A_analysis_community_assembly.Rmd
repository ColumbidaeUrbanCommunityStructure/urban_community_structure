...
plot_vsurp_result = function(result_table) {
  ...
  ggplot(p, aes(y=explanatory, x=estimate, colour = type)) + 
    ...
    scale_colour_manual(
      values = c(realm_colour, city_geography_colour, regional_50km_geography_colour, regional_20km_geography_colour, spatial_colour), 
      breaks = c('Realm', 'City geography', 'Regional (50km) geography', 'Regional (20km) geography', 'Spatial')) +
    theme_bw() +

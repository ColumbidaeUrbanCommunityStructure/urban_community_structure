...
plot_vsurp_result = function(result_table) {
  ...
  ggplot(p, aes(y=explanatory, x=estimate, colour = type)) + 
    ...
    scale_colour_manual(values = c('#d0a900', '#23d138', '#00f9ff', '#d642ff', '#9823c4', '#00ccd2'), breaks = c('Realm', 'City geography', 'Regional (50km) geography', 'Regional (20km) geography', 'Spatial')) +
    theme_bw() +

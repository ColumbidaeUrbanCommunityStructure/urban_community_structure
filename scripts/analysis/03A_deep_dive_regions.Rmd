...
plot_city_cluster(palearctic_cluster1[1:25,], 'Palearctic cluster 1a')
...
```{r}
plot_city_cluster(palearctic_cluster1[25:49,], 'Palearctic cluster 1b')
ggsave(filename(REGION_DEEP_DIVE_FIGURES_OUTPUT, 'palearctic_cluster1b.jpg'), width = get_image_width(palearctic_cluster1), height = get_image_height(palearctic_cluster1), units = "mm")
```
...
test_value('Australasia beak gape', australasia_cities$gape_width_fdiv_normalised)
test_value('Australasia kipps distance', australasia_cities$kipps_distance_fdiv_normalised)

...
g + 
  geom_fruit(geom = geom_point, mapping = aes(size = beak_width), colour = beak_width_colour, offset = 0, show.legend = FALSE) + 
  geom_fruit(geom = geom_point, mapping = aes(size = hwi), colour = hwi_colour, offset = 0.1, show.legend = FALSE) + 
  geom_fruit(geom = geom_point, mapping = aes(size = mass), colour = mass_colour, offset = 0.15, show.legend = FALSE) + 

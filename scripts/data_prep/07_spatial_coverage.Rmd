...
pools_city_data = pools_city_data %>% dplyr::select(city_id, city_name, total_city_checklists, total_city_locations, total_city_effort, total_city_area_m2, total_city_area_surveyed_m2, percentage_total_city_area_surveyed, jetz_species_name, percentage_checklists, percentage_locations, percentage_effort, percentage_surveyed_area, seasonal, presence, origin) %>% data.frame()
pools_city_data
```

...
world_map = st_read(COUNTRY_BOUNDARIES)
```
### Collared Dove
...
ggplot() +  
  ...
  geom_sf(data = columbidaeDistribution[columbidaeDistribution$SCI_NAME == 'Streptopelia decaocto', c('PRESENCE')], aes(geometry = geometry), fill = "red")
```
...
ggplot() +  
  geom_sf(data = world_map, aes(geometry = geometry)) +
  geom_sf(data = eucdov_range_vect["scientific_name"], aes(geometry = geometry), fill = "red")
```
...
ggplot() +  
  geom_sf(data = world_map, aes(geometry = geometry)) +
  geom_sf(data = columbidaeDistribution[columbidaeDistribution$SCI_NAME == 'Columba livia', c('PRESENCE')], aes(geometry = geometry), fill = "red")
```
...
ggplot() +  
  geom_sf(data = world_map, aes(geometry = geometry)) +
  geom_sf(data = rocpig_range_vect["scientific_name"], aes(geometry = geometry), fill = "red")
```
...
ggplot() +  
  geom_sf(data = world_map, aes(geometry = geometry)) +
  geom_sf(data = columbidaeDistribution[columbidaeDistribution$SCI_NAME %in% c('Spilopelia chinensis','Spilopelia suratensis','Patagioenas albipennis'), c('PRESENCE')], aes(geometry = geometry, fill = SCI_NAME))
```
...
ggplot() +  
  geom_sf(data = world_map, aes(geometry = geometry)) +
  geom_sf(data = spodov_range_vect["scientific_name"], aes(geometry = geometry), fill = "red")
```

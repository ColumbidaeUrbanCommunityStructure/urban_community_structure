...
```{r}
result[result_present$min_city_checklists %in% c(100, 500, 1000, 1500, 2000),]
```
...
```{r}
trimmed_data[trimmed_data$nonzero_abundance & trimmed_data$percentage_checklists < 2.5 & trimmed_data$total_city_checklists > 100,

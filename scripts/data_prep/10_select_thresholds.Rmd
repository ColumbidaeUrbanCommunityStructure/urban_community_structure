...
```{r}
reported_rows = c('city_id', 'city_name', 'percentage_checklists', 'percentage_locations', 'percentage_surveyed_area', 'total_city_checklists', 'total_city_locations', 'percentage_total_city_area_surveyed')
```
...
```{r}
all_species %>% 
  filter(total_city_checklists > 350) %>%
  summarise(
    number_records = n(),

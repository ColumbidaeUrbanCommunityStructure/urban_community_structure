...
### Read in eBird
```{r}
ebird_tax_input = read_csv(filename(EBIRD_WORKING_OUTPUT_DIR, 'taxonomy.csv'))
names(ebird_tax_input) = c('ebird_id', 'ebird_category', 'ebird_species_fullname', 'ebird_common_name')
head(ebird_tax_input)
```

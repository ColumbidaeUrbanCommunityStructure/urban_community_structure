...
```{r}
birdlife_tax_alt_names = birdlife_tax %>% 
  separate_rows(alternative_name, sep = ",") %>% 
  separate_rows(alternative_name, sep = ";") %>% 
  filter(!is.na(alternative_name))
...
ebird_birdlife_taxonomy_mapping = ebird_birdlife_taxonomy_mapping[!(ebird_birdlife_taxonomy_mapping$species_name %in% c(
  'Ectopistes migratorius', 'Columba thiriouxi', 'Nesoenas cicur', 'Raphus cucullatus', 'Alectroenas nitidissimus', 'Nesoenas rodericanus', 'Microgoura meeki', 'Caloenas maculata', 'Pezophaps solitaria', 'Alectroenas payandeei', 'Ptilinopus mercierii', 'Pampusana ferruginea', 'Pampusana salamonis', 'Columba jouyi', 'Columba versicolor'
)),]
```
...
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Macropygia cinnamomea'] = 'Macropygia_emiliana'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana hoedtii'] = 'Gallicolumba_hoedtii'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana jobiensis'] = 'Gallicolumba_jobiensis'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana kubaryi'] = 'Gallicolumba_kubaryi'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana xanthonura'] = 'Gallicolumba_xanthonura'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana erythroptera'] = 'Gallicolumba_erythroptera'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana rubescens'] = 'Gallicolumba_rubescens'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana beccarii'] = 'Gallicolumba_beccarii'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana canifrons'] = 'Gallicolumba_canifrons'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana sanctaecrucis'] = 'Gallicolumba_sanctaecrucis'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana stairi'] = 'Gallicolumba_stairi'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Pampusana johannae'] = 'Gallicolumba_beccarii'
ebird_birdlife_taxonomy_mapping$jetz_species_name[ebird_birdlife_taxonomy_mapping$species_name == 'Ducula nicobarica'] = 'Ducula_aenea'
```

```{r}
jetz_phylo_tree$tip.label[jetz_phylo_tree$tip.label %in% c('Gallicolumba_jobiensis')]
```
...
## Clean up Birdlife species
Check that all the species with NA as their birdlife common name, have a mapping already
```{r}
birdlife_species_with_na_common_name = ebird_birdlife_taxonomy_mapping[is.na(ebird_birdlife_taxonomy_mapping$birdlife_common_name),]
nrow(birdlife_species_with_common_name)
```

```{r}
birdlife_species_with_common_name = ebird_birdlife_taxonomy_mapping[!is.na(ebird_birdlife_taxonomy_mapping$birdlife_common_name),]

birdlife_species_with_na_common_name[!(birdlife_species_with_na_common_name$species_name %in% birdlife_species_with_common_name$species_name),]
```

```{r}
birdlife_species_with_na_common_name[!(birdlife_species_with_na_common_name$ebird_species_name %in% birdlife_species_with_common_name$ebird_species_name),]
```

```{r}
ebird_birdlife_taxonomy_mapping = ebird_birdlife_taxonomy_mapping[!is.na(ebird_birdlife_taxonomy_mapping$birdlife_common_name),]
```
